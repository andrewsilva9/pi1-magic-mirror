...
<div class="wrap" id="stock_ticker_settings">
	...
	<div class="help">
		...
		<p><?php printf( esc_attr__( 'You also can use shortcode %s where:', 'wpaust' ), '<code>[stock_ticker symbols="" show="" static="" nolink="" class=""]</code>' ); ?>
			<ul>
				...
				<li><code>prefill</code> <?php printf( esc_attr__( 'to start with pre-filled instead empty ticker set to %s or %s', 'wpaust' ), '<code>1</code>', '<code>true</code>' ); ?></li>
				<li><code>duplicate</code> <?php printf( esc_attr__( 'if there is less items than visible on the ticker, set this to %s or %s to make it continuous', 'wpaust' ), '<code>1</code>', '<code>true</code>' ); ?></li>
